...
def emptyNet():
    ...
    time.sleep(20)
    l1.intf1.config(bw=1)
    l1.intf2.config(bw=1)
    l2.intf1.config(bw=1)
    l2.intf2.config(bw=1) 

    time.sleep(40)
    l1.intf1.config(bw=5)
    l1.intf2.config(bw=5)
    l2.intf1.config(bw=5)
    l2.intf2.config(bw=5)    
